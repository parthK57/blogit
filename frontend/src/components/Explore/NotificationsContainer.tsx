    ...
    <>
      <div className="w-[90%] overflow-hidden rounded bg-blue-100 shadow-sm">
        <div className="flex flex-col items-center gap-3">
          <div className="flex w-[100%] items-center justify-between bg-blue-300 px-4 py-2 text-2xl shadow">
            Notifications <IoNotifications className="text-white" />
          </div>
          <div className="flex w-max items-center rounded-md bg-blue-200 px-2 py-1 font-Sono text-lg shadow-sm">
            {fullName} <RxDotFilled className="text-green-400" />
          </div>
          <div className="mb-2 flex h-[80px] w-[100%] flex-col justify-center gap-2 overflow-y-scroll bg-blue-100 px-2">
            ...
            {Notifications.length === 0 ? (
              <div className="cursor-default rounded bg-blue-200 px-2 py-2 hover:bg-white hover:text-blue-400">
