    ...
    <>
      <div className="flex h-[80px] w-screen items-center justify-between bg-blue-100 px-4">
        <div className="flex items-center rounded-md bg-blue-200 px-2 py-1 text-2xl transition-all duration-300 ease-in-out hover:scale-110">
          <p className="font-Sono">blogs</p>
        </div>
        <div className="text-md hidden gap-7 md:flex">
          <p className="pointer-events-auto cursor-pointer">Home</p>
          <p className="pointer-events-auto cursor-pointer">Account</p>
          <p className="pointer-events-auto cursor-pointer">Create</p>
          <p className="pointer-events-auto cursor-pointer">Public</p>
        </div>
        <RxHamburgerMenu
          onClick={toggler}
